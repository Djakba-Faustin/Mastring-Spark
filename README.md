...
- **SQL & DataFrames API** - SQL queries on Spark DataFrames
- **Data Processing** - Transformations and actions
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Djakba-Faustin/Mastring-Spark.git
   cd Mastring-Spark
   ```
...
3. **Run the code** - Execute cells to see results and experiment
...
Start with the first notebook and progress through the collection at your own pace. Remember, the best way to learn Spark is by writing code!
